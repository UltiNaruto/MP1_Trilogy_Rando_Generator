        ...
        internal static void SwitchTab(int selected)
        {
            ...
            if (Instance.InvokeRequired) {
                ...
                if (!Instance.isLoading)
                {
                    ...
                    // Plandomizer tab selected
                    Instance.plandomizer_btn.Enabled = selected != 2;
                    Instance.plandomizer_btn.BackColor = selected == 2 ? Color.Gray : Color.FromArgb(60, 63, 65);
                    // Settings tab selected
                    Instance.settings_btn.Enabled = selected != 3;
                    Instance.settings_btn.BackColor = selected == 3 ? Color.Gray : Color.FromArgb(60, 63, 65);
